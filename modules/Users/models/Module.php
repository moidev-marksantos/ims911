...
class Users_Module_Model extends Vtiger_Module_Model
{
	...
	public function saveLoginHistory($username)
	{
		...
		$userIPAddress = $_SERVER['HTTP_CLIENT_IP'] ? : ($_SERVER['HTTP_X_FORWARDED_FOR'] ? : $_SERVER['REMOTE_ADDR']);  		
	...
	{
		$blocksList = array(
			'Edit'			=> array('block' => 'LBL_USER_MANAGEMENT', 'menu' => 'LBL_USERS'),
	...
	public function getModuleBasicLinks()
	{
		...
		if ($currentUser->isAdminUser() && Users_Privileges_Model::isPermitted($moduleName, 'CreateView')) {
			if ($currentUser->getusercount() < $responder_limit) {
				$basicLinks[] = array(
					'linktype' => 'BASIC',
