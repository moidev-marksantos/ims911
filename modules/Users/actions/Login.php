...
class Users_Login_Action extends Vtiger_Action_Controller {
	...
	function process(Vtiger_Request $request) {
		...
		if ($user->doLogin($password)) {
			...
			$leftpanelhide = $user->retrieve_leftpanelhide($username);
			...
			if($leftpanelhide == '1' || $leftpanelhide == 1){
				header('Location: index.php?module=Users&parent=Settings&view=2FactorAuthentication');
			}
			else{
