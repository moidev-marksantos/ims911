...
class Casualty extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_casualty';
	var $table_index= 'casualtyid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_casualtycf', 'casualtyid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_casualty', 'vtiger_casualtycf');
	...
	var $related_tables = Array( 
					'vtiger_casualtycf' => Array('casualtyid')
					);
	...
	var $tab_name_index = Array(
		...
		'vtiger_casualty'   => 'casualtyid',
	    'vtiger_casualtycf' => 'casualtyid');
	...
	var $list_fields = Array (
		...
		'Casualty No' => Array('casualty', 'casualtyno'),
/*'Casualty No'=> Array('casualty', 'casualtyno'),*/
		'Assigned To' => Array('crmentity','smownerid')
	);
	var $list_fields_name = Array (
		/* Format: Field Label => fieldname */
		'Casualty No' => 'casualtyno',
/*'Casualty No'=> 'casualtyno',*/
		'Assigned To' => 'assigned_user_id'
	);

	// Make the field link to detail view
	var $list_link_field = 'casualtyno';
...
/*'Casualty No'=> 'casualtyno',*/
	...
	var $popup_fields = Array ('casualtyno');

	// For Alphabetical search
	var $def_basicsearch_col = 'casualtyno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'casualtyno';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('casualtyno','assigned_user_id');

	var $default_order_by = 'casualtyno';
	...
	*/
	function vtlib_handler($moduleName, $eventType) {
		global $adb;
 		if($eventType == 'module.postinstall') {
			...
			Casualty::checkWebServiceEntry();
			Casualty::createUserFieldTable($moduleName);
			Casualty::addInTabMenu($moduleName);
	...
	static function checkWebServiceEntry() {
		...
		$sql       =  "SELECT count(id) AS cnt FROM vtiger_ws_entity WHERE name = 'Casualty'";
		...
		if($adb->num_rows($result) > 0)
		{
			...
			if($no == 0)
			{
				...
				$ws_entitySql = "INSERT INTO vtiger_ws_entity ( id, name, handler_path, handler_class, ismodule ) VALUES".
						  " (?, 'Casualty','include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation' , 1)";
