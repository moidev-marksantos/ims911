...
class Vtiger_Detail_View extends Vtiger_Index_View {
	...
	function __construct() {
		...
		$this->exposeMethod('showRelatedMedia');
	}
	...
	function preProcess(Vtiger_Request $request, $display=true) {
		...
		if($moduleName == 'HelpDesk'){
			$viewer->assign('RESPONDERS', $recordModel->getResponders());
			$viewer->assign('RESPONDERLOGS', $recordModel->getResponderLogs());
		}
	...
	function showRelatedMedia(Vtiger_Request $request) {
		$parentId = $request->get('record');
		$moduleName = $request->getModule();
		$getdocumentlist = Vtiger_Record_Model::getDocumentListRelatedToIncident($parentId);
		$viewer = $this->getViewer($request);
		$viewer->assign('DOCUMENT_LIST', $getdocumentlist);		

		return $viewer->view('ShowRelatedMedia.tpl', $moduleName, 'true');
	}
