...
class Vtiger_Util_Helper {
	...
	public static function getPickListValues($fieldName) {
		...
		$query = 'SELECT '.$primaryKey.', '.$fieldName.' FROM vtiger_'.$fieldName.' ORDER BY '. $fieldName .' ASC';
		$values = array();
	...
	public static function getRoleBasedPicklistValues($fieldName, $roleId) {
		...
		$query = "SELECT $fieldName
				  ...
				  WHERE roleid=? and picklistid in (select picklistid from vtiger_picklist) order by $fieldName asc";
