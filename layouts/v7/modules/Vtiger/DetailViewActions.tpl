    ...
    <div class="col-lg-6 detailViewButtoncontainer">
        <div class="pull-right btn-toolbar">
            ...
            {foreach item=DETAIL_VIEW_BASIC_LINK from=$DETAILVIEW_LINKS['DETAILVIEWBASIC']}
                {if vtranslate($DETAIL_VIEW_BASIC_LINK->getLabel(), $MODULE_NAME) eq 'Print Report'}
                    <a target="_blank" href="{$DETAIL_VIEW_BASIC_LINK->getUrl()}" class="btn btn-default">Print Report</a>
                    {else}
