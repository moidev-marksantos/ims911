...
<html>
	<head>
        <title>
        {if $smarty.request.view eq 'IncidentMap'} 
            Incident Map 
        ...
        <link type='text/css' rel='stylesheet' href='layouts/v7/lib/todc/css/todc-bootstrap.css'>        
        ...
        <link type="text/css" rel="stylesheet" href="layouts/microbiz/common.css">            
        <link type='text/css' rel='stylesheet' href='libraries/themify-icons/themify-icons.css'>

        

        <!-- START: ADDED BY MARK : THIS IS FOR MAP-->	
        ...
        <!-- END: ADDED BY MARK : THIS IS FOR MAP-->
        ...
        <link type="text/css" rel="stylesheet" href="layouts/v7/skins/vtiger/style.css">  
	</head>
