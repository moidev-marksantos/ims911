...
Vtiger.Class("Vtiger_Detail_Js",{
	...
	triggerSendEmailforTicket : function(detailActionUrl, module){
		var currentInstance = window.app.controller();
		var parentRecord = new Array();
		var params = {};
		parentRecord.push(currentInstance.getRecordId());
		...
		urlParams['selected_ids'] = parentRecord;		
		var subject2 = $(".ticket_title").text();
		Vtiger_Index_Js.showComposeEmailPopup(urlParams,function(response) {
			jQuery('#subject', response).val("RE: " + subject2);
		});
	},
