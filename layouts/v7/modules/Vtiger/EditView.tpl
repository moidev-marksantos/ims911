					...
					<div class="editViewHeader">
						<div class='row'>
							<div class="col-lg-12 col-md-12 col-lg-pull-0">
								...
								{if $RECORD_ID neq ''}
									<h5 class="editHeader" style="margin-top:2px;" title="{vtranslate('LBL_EDITING', $MODULE)} {vtranslate($SINGLE_MODULE_NAME, $MODULE)} {$RECORD_STRUCTURE_MODEL->getRecordName()}">{vtranslate('LBL_EDITING', $MODULE)} {vtranslate($SINGLE_MODULE_NAME, $MODULE)} - {$RECORD_STRUCTURE_MODEL->getRecordName()}</h5>
								{else}
									<h5 class="editHeader" style="margin-top:2px;">{vtranslate('LBL_CREATING_NEW', $MODULE)} {vtranslate($SINGLE_MODULE_NAME, $MODULE)}</h5>
								{/if}
							</div>
						</div>
					</div>
					...
					<div class='modal-overlay-footer clearfix'>
						<div class="row clearfix">
							<div class='textAlignCenter col-lg-12 col-md-12 col-sm-12 '>
								...
								<a class='cancelLink' href="javascript:closeWindow();" type="reset">{vtranslate('LBL_CANCEL', $MODULE)}</a>
								{literal}
								<script>
