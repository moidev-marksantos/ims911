...
<div class="modal-dialog">
    <div class="modal-content">
        <form class="form-horizontal" id="massSave" method="post" action="index.php">
            ...
            {include file="ModalHeader.tpl"|vtemplate_path:$MODULE SOURCE_MODULE=$SOURCE_MODULE TITLE=$HEADER_TITLE}

            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row commentTextArea" id="mass_action_add_comment">                    
                    <textarea class="col-lg-12" name="commentcontent" id="commentcontent" rows="5" placeholder="{if $SOURCE_MODULE eq 'Responder'}Enter message here...{else}{vtranslate('LBL_WRITE_YOUR_COMMENT_HERE', $MODULE)}...{/if}" data-rule-required="true"></textarea>
                    </div>
                </div>
            </div>
