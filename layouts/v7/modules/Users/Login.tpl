...
{strip}
	<style>
		...
		.buttonBlue {
			background-image: linear-gradient(to bottom, #032e6 0px, #032e6 100%)
		}
		.ripples {
			position: absolute;
			top: 0;
			...
			<div class="loginDiv widgetHeight">
				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
						...
						<div class="group">
							<button type="submit" class="button buttonBlue" style="background-color: #ed3237;">Sign in</button><br>
				...
				<div id="forgotPasswordDiv" class="hide">
					<form class="form-horizontal" action="forgotPassword.php" method="POST">
						...
						<div class="group">
							<button type="submit" style="background-color: #ed3237;" class="button buttonBlue forgot-submit-btn">Submit</button><br>
