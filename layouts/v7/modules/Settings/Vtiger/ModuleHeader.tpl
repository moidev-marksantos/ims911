...
{strip}
	<div class="col-sm-12 col-xs-12 module-action-bar clearfix coloredBorderTop" style="background-color: #032e61; color: #fff;">
		<div class="module-action-content clearfix" style="background-color: #032e61; color: #fff;">
			<div class="col-lg-7 col-md-7" style="background-color: #032e61; color: #fff;">
			...
			<div class="col-lg-5 col-md-5 pull-right" style="background-color: #032e61; color: #fff;">
