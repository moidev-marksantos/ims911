...
Vtiger_Reference_Field_Js("Workflows_Reference_Field_Js",{},{
    getUi : function(){
        ...
        if(reset){
            html += '<a href="#" class="clearReferenceSelection"><i class="ti-close p-l-8"></i></a>';
        }else {
            html += '<a href="#" class="clearReferenceSelection hide"><i class="ti-close p-l-8"></i></a>';
        }
        html += '</span>';
        ...
        html += '<i class="ti-search p-l-8"></i>';
        html += '</span>';
