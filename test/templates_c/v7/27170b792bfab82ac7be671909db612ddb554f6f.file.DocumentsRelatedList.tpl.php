<?php /* Smarty version Smarty-3.1.7, created on 2021-03-03 01:59:19
         compiled from "/home/radifjev/bayan911.com/sbmademo/includes/runtime/../../layouts/v7/modules/Documents/DocumentsRelatedList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1930840232603eed77d25581-24923553%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '27170b792bfab82ac7be671909db612ddb554f6f' => 
    array (
      0 => '/home/radifjev/bayan911.com/sbmademo/includes/runtime/../../layouts/v7/modules/Documents/DocumentsRelatedList.tpl',
      1 => 1612992690,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1930840232603eed77d25581-24923553',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_603eed77db405',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_603eed77db405')) {function content_603eed77db405($_smarty_tpl) {?>
...
</button></div><?php }?><?php if ($_smarty_tpl->tpl_vars['RELATED_LINK']->value->getLabel()=='Vtiger'){?><?php if ($_smarty_tpl->tpl_vars['IS_CREATE_PERMITTED']->value){?><div class="col-sm-3"><div class="dropdown"><button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"><span class="ti-plus" title="<?php echo vtranslate('LBL_NEW_DOCUMENT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
')"><i class="fa fa-upload"></i> <?php echo vtranslate('LBL_FILE_UPLOAD','Documents');?>
...
<?php $_tmp4=ob_get_clean();?><?php echo vtranslate('LBL_FROM_SERVICE',$_smarty_tpl->tpl_vars['RELATED_MODULE_NAME']->value,$_tmp4);?>
...
<?php $_tmp5=ob_get_clean();?><?php echo vtranslate('LBL_CREATE_NEW',$_smarty_tpl->tpl_vars['RELATED_MODULE_NAME']->value,$_tmp5);?>
...
" class="fa fa-picture-o alignMiddle"></i></a>&nbsp;&nbsp;<?php }?></span></td><?php  $_smarty_tpl->tpl_vars['HEADER_FIELD'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['HEADER_FIELD']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['RELATED_HEADERS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['HEADER_FIELD']->key => $_smarty_tpl->tpl_vars['HEADER_FIELD']->value){
$_smarty_tpl->tpl_vars['HEADER_FIELD']->_loop = true;
