<?php /* Smarty version Smarty-3.1.7, created on 2021-11-25 15:31:00
         compiled from "C:\xampp7.4\htdocs\bayan911\includes\runtime/../../layouts/v7\modules\Vtiger\JSResources.tpl" */ ?>
<?php /*%%SmartyHeaderCode:155686827060e690e92eabf9-67283814%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '02d38956fceffa6b31aa9963e7b1e9c9a1c93292' => 
    array (
      0 => 'C:\\xampp7.4\\htdocs\\bayan911\\includes\\runtime/../../layouts/v7\\modules\\Vtiger\\JSResources.tpl',
      1 => 1637825459,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '155686827060e690e92eabf9-67283814',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_60e690e9376d1',
  'variables' => 
  array (
    'SCRIPTS' => 0,
    'jsModel' => 0,
...
<?php if ($_valid && !is_callable('content_60e690e9376d1')) {function content_60e690e9376d1($_smarty_tpl) {?>
...
"></script><!-- Added in the end since it should be after less file loaded --><script type="text/javascript" src="libraries/bootstrap/js/less.min.js"></script><script>/*var params = {title: app.vtranslate('JS_PBX_INCOMING_CALL'),message: `<div class="row-fluid pbxcall"><span>John Doe</span><br><span>Number: 100</span><br><br><a class="btn btn-primary btn-sm" href="index.php?module=HelpDesk&view=Edit&app=MARKETING">Answer</a></div>`,};var settings = {delay: 0,placement: {from: 'top',align: 'right'}};jQuery.notify(params, settings);*/</script><!-- Enable tracking pageload time --><script type="text/javascript">var _REQSTARTTIME = "<?php echo $_SERVER['REQUEST_TIME'];?>
