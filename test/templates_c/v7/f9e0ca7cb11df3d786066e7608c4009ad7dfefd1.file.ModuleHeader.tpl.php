<?php /* Smarty version Smarty-3.1.7, created on 2021-02-10 03:16:16
         compiled from "C:\xampp\htdocs\bayan911demo\includes\runtime/../../layouts/v7\modules\Settings\Vtiger\ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:147197567602350003e1555-58127953%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f9e0ca7cb11df3d786066e7608c4009ad7dfefd1' => 
    array (
      0 => 'C:\\xampp\\htdocs\\bayan911demo\\includes\\runtime/../../layouts/v7\\modules\\Settings\\Vtiger\\ModuleHeader.tpl',
      1 => 1611607540,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '147197567602350003e1555-58127953',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6023500045fcb',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6023500045fcb')) {function content_6023500045fcb($_smarty_tpl) {?>

<div class="col-sm-12 col-xs-12 module-action-bar clearfix coloredBorderTop" style="background-color: #032e61; color: #fff;"><div class="module-action-content clearfix" style="background-color: #032e61; color: #fff;"><div class="col-lg-7 col-md-7" style="background-color: #032e61; color: #fff;"><?php if ($_smarty_tpl->tpl_vars['USER_MODEL']->value->isAdminUser()){?><a title="<?php echo vtranslate('Home',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</span></span><?php }?><?php }?></div><div class="col-lg-5 col-md-5 pull-right" style="background-color: #032e61; color: #fff;"><div id="appnav" class="navbar-right"><ul class="nav navbar-nav"><?php  $_smarty_tpl->tpl_vars['BASIC_ACTION'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['BASIC_ACTION']->_loop = false;
