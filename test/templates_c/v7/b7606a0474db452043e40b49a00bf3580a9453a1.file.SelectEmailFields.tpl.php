<?php /* Smarty version Smarty-3.1.7, created on 2022-01-04 13:08:55
         compiled from "/opt/lampp/htdocs/bayan911/includes/runtime/../../layouts/v7/modules/HelpDesk/SelectEmailFields.tpl" */ ?>
<?php /*%%SmartyHeaderCode:199555213361d3d6673f9e11-61188426%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b7606a0474db452043e40b49a00bf3580a9453a1' => 
    array (
      0 => '/opt/lampp/htdocs/bayan911/includes/runtime/../../layouts/v7/modules/HelpDesk/SelectEmailFields.tpl',
      1 => 1637898757,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '199555213361d3d6673f9e11-61188426',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61d3d6674a809',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61d3d6674a809')) {function content_61d3d6674a809($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/opt/lampp/htdocs/bayan911/libraries/Smarty/libs/plugins/function.counter.php';
?>
...
<?php if ($_smarty_tpl->tpl_vars['EMAIL_FIELDS_INFO']->value){?><?php  $_smarty_tpl->tpl_vars['EMAIL_MODULE_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['EMAIL_MODULE_INFO']->_loop = false;
...
<?php } ?><?php } ?></div><?php } ?><?php }?></div><?php if ($_smarty_tpl->tpl_vars['RELATED_LOAD']->value==true){?><input type="hidden" name="relatedLoad" value=<?php echo $_smarty_tpl->tpl_vars['RELATED_LOAD']->value;?>
