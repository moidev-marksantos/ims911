<?php /* Smarty version Smarty-3.1.7, created on 2021-03-18 01:15:10
         compiled from "/home/radifjev/bayan911.com/sbmademo/includes/runtime/../../layouts/v7/modules/Reports/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6236968016052a99e5a6e77-53523149%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '81e371088286bd86982b2002a1feacd15324508d' => 
    array (
      0 => '/home/radifjev/bayan911.com/sbmademo/includes/runtime/../../layouts/v7/modules/Reports/ListViewContents.tpl',
      1 => 1611651312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6236968016052a99e5a6e77-53523149',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6052a99e5f8a1',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6052a99e5f8a1')) {function content_6052a99e5f8a1($_smarty_tpl) {?>
...
&nbsp;</a><?php if ($_smarty_tpl->tpl_vars['COLUMN_NAME']->value==$_smarty_tpl->tpl_vars['LISTVIEW_HEADER_KEY']->value){?><a href="#" class="removeSorting"><i class="fa fa-remove"></i></a><?php }?></th><?php } ?></tr><?php if ($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->isQuickSearchEnabled()&&!$_smarty_tpl->tpl_vars['SEARCH_MODE_RESULTS']->value){?><tr class="searchRow listViewSearchContainer"><th class="inline-search-btn"><div class="table-actions"><button class="btn-sm btn btn-success <?php if (count($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value)>0){?>hide<?php }?>" data-trigger="listSearch"><i class="ti-search"></i>&nbsp;<span class="s2-btn-text"><?php echo vtranslate("LBL_SEARCH",$_smarty_tpl->tpl_vars['MODULE']->value);?>
</span></button><button class="searchAndClearButton btn-sm  btn btn-danger <?php if (count($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value)==0){?>hide<?php }?>" data-trigger="clearListSearch"><i class="ti-close"></i>&nbsp;<?php echo vtranslate("LBL_CLEAR",$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
"><i class="ti-list"></i>&nbsp;List Report</center><?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value=='chart'){?><center title="<?php echo vtranslate('LBL_CHART_REPORT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"><i class="ti-bar-chart"></i>&nbsp;Chart Report</center><?php }?><?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value=='primarymodule'){?><?php echo Vtiger_Util_Helper::tosafeHTML(decode_html(vtranslate($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value,$_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value)));?>
