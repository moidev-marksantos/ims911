<?php /* Smarty version Smarty-3.1.7, created on 2021-03-18 01:09:36
         compiled from "/home/radifjev/bayan911.com/sbmademo/includes/runtime/../../layouts/v7/modules/Settings/Profiles/DetailView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20697855676052a8508c4937-72441384%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '16ae2a452cd1cae2fd12a0c0179f1933f4087d33' => 
    array (
      0 => '/home/radifjev/bayan911.com/sbmademo/includes/runtime/../../layouts/v7/modules/Settings/Profiles/DetailView.tpl',
      1 => 1602674194,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20697855676052a8508c4937-72441384',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6052a85091e0a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6052a85091e0a')) {function content_6052a85091e0a($_smarty_tpl) {?>
...
?><tr><?php $_smarty_tpl->tpl_vars['MODULE_PERMISSION'] = new Smarty_variable($_smarty_tpl->tpl_vars['RECORD_MODEL']->value->hasModulePermission($_smarty_tpl->tpl_vars['PROFILE_MODULE']->value), null, 0);?><td data-module-name='<?php echo $_smarty_tpl->tpl_vars['PROFILE_MODULE']->value->getName();?>
...
' style="text-align: center;"><?php if ($_smarty_tpl->tpl_vars['ACTION_MODEL']->value->isModuleEnabled($_smarty_tpl->tpl_vars['PROFILE_MODULE']->value)){?><img src="<?php if ($_smarty_tpl->tpl_vars['MODULE_ACTION_PERMISSION']->value){?><?php echo $_smarty_tpl->tpl_vars['ENABLE_IMAGE_PATH']->value;?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['DISABLE_IMAGE_PATH']->value;?>
...
</td><?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['actions']['last']||($_smarty_tpl->getVariable('smarty')->value['foreach']['actions']['index']+1)%3==0){?></div><?php }?><?php } ?></table></div></td></tr><?php } ?></tbody></table></div></div></div></div></div></div>
<?php }} ?>