<?php /* Smarty version Smarty-3.1.7, created on 2021-03-18 05:11:33
         compiled from "/home/radifjev/bayan911.com/sbmademo/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1227006731603eed269cf591-07954866%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b585773d66730f59579b4a0da76ad6fb3efdd6c8' => 
    array (
      0 => '/home/radifjev/bayan911.com/sbmademo/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewContents.tpl',
      1 => 1616044287,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1227006731603eed269cf591-07954866',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_603eed26a66f3',
  'variables' => 
  array (
    'MODULE' => 0,
...
<?php if ($_valid && !is_callable('content_603eed26a66f3')) {function content_603eed26a66f3($_smarty_tpl) {?>
...
&nbsp;
                        ...
                        <?php } ?>
                        <th><?php if (!$_smarty_tpl->tpl_vars['SEARCH_MODE_RESULTS']->value){?>
                            <div class="table-actions">                            
                                <?php if ($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->isFilterColumnEnabled()){?>
                                <div id="listColumnFilterContainer">
                                    <div class="listColumnFilter <?php if ($_smarty_tpl->tpl_vars['CURRENT_CV_MODEL']->value&&!($_smarty_tpl->tpl_vars['CURRENT_CV_MODEL']->value->isCvEditable())){?>disabled<?php }?>" <?php if ($_smarty_tpl->tpl_vars['CURRENT_CV_MODEL']->value->isCvEditable()){?>
...
">
                        ...
                        <th class="inline-search-btn">
                            <div class="table-actions">
                                ...
                                <button class="searchAndClearButton t-btn-sm btn btn-danger <?php if (count($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value)==0){?>hide<?php }?>" data-trigger="clearListSearch"><i class="ti-close"></i>&nbsp;<?php echo vtranslate("LBL_CLEAR",$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button>
                            </div>
                        </th>
                    </tr>
...
' <?php }?>>
                        <td style="width: 20px;"><?php if (!$_smarty_tpl->tpl_vars['SEARCH_MODE_RESULTS']->value){?>
                            <span class="input">
...
" <?php }?>>
                                    ...
                                    <?php } ?>
                                    <?php }else{ ?>
                                    <?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getFieldDataType()=='phone'){?>
                                        <a href="tel:<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value;?>
" style="text-decoration: underline;"><?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value;?>
</a>
                                    <?php }else{ ?>
                                        <?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value;?>
